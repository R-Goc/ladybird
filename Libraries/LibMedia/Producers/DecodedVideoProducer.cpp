...
static constexpr int VIDEO_AUTO_SUSPEND_IDLE_TIMEOUT_MS = 10000;
...
void DecodedVideoProducer::ThreadData::wait_for_queue_space_or_auto_suspend_while_locked()
{
    ...
    auto idle_at = m_last_consumer_activity + AK::Duration::from_milliseconds(VIDEO_AUTO_SUSPEND_IDLE_TIMEOUT_MS);
